...
- To understand how ROS 2 architecture supports URDF models in robotics applications, see [Module 1: ROS 2 Fundamentals](../module-1-ros2-fundamentals/architecture)
- For implementing communication between URDF-based robot components, see [Module 2: ROS 2 Communication](../module-1-ros2-communication/nodes-topics-services)
