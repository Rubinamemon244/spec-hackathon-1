...
- **Perception Integration**: Nav2 uses perception data from Isaac ROS nodes [→ Isaac ROS Perception](./isaac-ros-vslam-navigation#isaac-ros-architecture)
...
- **Performance Considerations**: How all components interact for optimal performance [→ Performance Evaluation](./nvidia-isaac-integrated-project#phase-4-performance-evaluation)
