...
const config = {
  ...
  tagline: 'Learn ROS 2 fundamentals, communication patterns, and URDF modeling for AI students entering humanoid robotics',
  ...
  url: 'https://vercel.com/rubina-memons-projects/spec-hackathon-1',
  ...
  themeConfig:
    ...
    ({
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/module-1-ros2-communication',
              },
              {
                label: 'URDF Modeling',
                to: '/docs/module-1-urdf-modeling',
              },
              {
      ...
      // Search configuration - required when using @docusaurus/theme-search-algolia
      algolia: {
        appId: 'YOUR_APP_ID',
        apiKey: 'YOUR_SEARCH_API_KEY',
        indexName: 'hackathon-1-ros2',
